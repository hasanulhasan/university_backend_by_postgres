...
CREATE TABLE "students" (
    ...
    "createdAT" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
    "academicSelesterId" TEXT NOT NULL,
...
-- AddForeignKey
ALTER TABLE "students" ADD CONSTRAINT "students_academicSelesterId_fkey" FOREIGN KEY ("academicSelesterId") REFERENCES "academic_semesters"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
